...
@set COINARCHIVE=RIchCoin-Core-0.6.2.tar.gz
@set COINDOWNLOADPATH=https://github.com/RIchCoin-devs/RIchCoin-Core/archive/v0.6.2-tar.gz
@rem folder within COINARCHIVE
@set COINFOLDER=RIchCoin-Core-0.6.2
