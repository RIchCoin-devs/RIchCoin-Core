...
usage () {
	echo "USAGE: build-RIchCoin.sh [-v version] [-s SIGNER] [-d true/false]"
	echo "Where v(ersion) should be the next version of the wallet"
	echo "Where s(igner) is used for the gitian signature, for example drakandar@RIchCoin.github.io - no signer will skip signatures"
...
# Clone sources
git clone git://github.com/RIchCoinTeam/fair-coin.git RIchCoin
...
bin/gbuild ../RIchCoin/contrib/gitian-descriptors/boost-linux.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../RIchCoin/contrib/gitian-descriptors/deps-linux.yml
mv build/out/RIchCoin-deps-*.zip inputs/

bin/gbuild ../RIchCoin/contrib/gitian-descriptors/qt-linux.yml
mv build/out/qt-*.tar.gz inputs/

bin/gbuild ../RIchCoin/contrib/gitian-descriptors/boost-win.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../RIchCoin/contrib/gitian-descriptors/deps-win.yml
mv build/out/RIchCoin-deps-*.zip inputs/

bin/gbuild ../RIchCoin/contrib/gitian-descriptors/qt-win.yml
mv build/out/qt-*.zip inputs/

bin/gbuild ../RIchCoin/contrib/gitian-descriptors/protobuf-win.yml
...
cd ..
git clone https://github.com/RIchCoinTeam/gitian.sigs.git
