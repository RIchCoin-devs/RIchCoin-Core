...
Intro
-----
RIchCoin is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  RIchCoind
You would need to create a configuration file RIchCoin.conf in the default
wallet directory. Grant access to RIchCoind.exe in anti-virus and firewall
...
RIchCoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
RIchCoind stop
Start up the new RIchCoind (0.3.0).
